# SITUATION REPORT: State-Actor Climate Disinformation Targeting Europe
...
On 20 July 2026, France24's Observers team reported on an IRIS (Institut de Relations Internationales et Stratégiques) study that frames climate disinformation as a tool of information warfare against Europe. The report, co-authored by Mathilde Jourde, who heads IRIS's Climate, Environment and Security programme, argues that foreign actors attach disinformation to extreme-weather events because those events generate fear quickly and cheaply, and that European climate and energy policy, especially the European Green Deal, is a recurring target.
...
The evidentiary weight is uneven. The existence and behaviour of specific vehicles are well established. The causal claim that these efforts meaningfully shift European public opinion is asserted rather than measured, and the characterisation of the current US administration's climate communications as "disinformation" is both IRIS's framing and a matter of political dispute.
...
United States. IRIS characterises US-linked climate disinformation as more overt, especially since the start of Donald Trump's second term, and as travelling partly through official channels. France24 quotes Jourde citing disputed figures in a US Department of Energy climate report and the removal of terms such as "climate change" and "green" from government websites. The report also points to think tanks aligned with the administration's position, naming the Heartland Institute, which is openly skeptical of human-caused climate change, reportedly draws funding from firms such as ExxonMobil and Republican donors, and opened a London office in 2024 to influence European energy policy. The framing of official US climate communications as "disinformation" is IRIS's, and is contested.
...
| Item | Detail |
|---|---|
| Source study | IRIS, "Climate Disinformation and Information Warfare: State Interference and Security Implications" (May 2026) |
| Lead researcher cited | Mathilde Jourde, head of Climate, Environment and Security, IRIS |
| Principal actors named | Russia and the United States; China in a defensive role |
| Primary target | European climate and energy policy (European Green Deal) |
| Russian vehicle | Portal Kombat network (exposed by Viginum, Feb 2024; ~193 portals) |
| US-linked vehicle | Heartland Institute (UK/Europe office opened London, Dec 2024) |
| Event case studies | 2023 Maui wildfires; 2024 Valencia floods (>200 dead); 2026 European heatwaves |
| Reported by | FRANCE 24 Observers, 20 July 2026 |

## Indicative timeline

| Date | Event | Significance |
|---|---|---|
| Since 2022 | EU bans Russia Today; Russian content shifts to concealed channels | Sets up the covert-amplification model |
| Aug 2023 | Russian campaign falsely claims US funds Ukraine over Maui wildfire victims | Early weather-event exploitation cited by IRIS |
| Feb 2024 | Viginum exposes the Portal Kombat network | Independent state-agency documentation of a Russian vehicle |
...
**IRIS.** Frames climate disinformation as a security problem and a lever of destabilisation, and is explicit that the disinformation may be a means to a broader geopolitical end rather than the end itself. IRIS is a French strategic-affairs think tank, and this note was produced under its defence-and-climate observatory, which works for the French armed forces ministry.

**Russia.** Not quoted in the reporting. Russian officials have generally rejected Western attributions of information operations. The Portal Kombat attribution rests on Viginum's technical investigation rather than on IRIS alone.

**United States.** Not quoted in the reporting. The characterisation of the administration's climate communications as disinformation is contested, and defenders would frame the same website and reporting changes as legitimate policy and editorial choices rather than an influence operation.

**Heartland Institute.** Publicly and openly campaigns against climate regulation; it does not present itself as covert. Its London launch was announced openly and attended by prominent political figures, which distinguishes it from concealed networks like Portal Kombat.
...
This is a landscape assessment rather than a single-incident report, and its value is in naming the vehicles and the event-exploitation pattern rather than in proving effect. The strongest, independently corroborated elements are the documented existence of specific channels: Viginum's Portal Kombat investigation on the Russian side, and Heartland's public European expansion on the US-aligned side. The weakest elements are the measured impact on European opinion, which is asserted, and the equivalence drawn between covert networks and overt advocacy.
...
- [FRANCE 24 — How state actors are exploiting climate crises to spread disinformation](https://www.france24.com/en/europe/20260720-foreign-state-actors-exploiting-climate-crises-spread-disinformation) (20 July 2026)
- [IRIS / Observatoire Défense et Climat — Climate Disinformation and Information Warfare (English note, PDF)](https://defenseclimat.fr/wp-content/uploads/2026/06/ObsDefClim_2026_04_Desinformation_Note_EN.pdf)
- [Ministère de l'Europe et des Affaires étrangères — Result of Viginum investigations into the Portal Kombat network](https://www.diplomatie.gouv.fr/en/french-foreign-policy/security-disarmament-and-non-proliferation/news/2024/article/foreign-digital-interference-result-of-investigations-into-the-russian) (12 February 2024)
- [E&E News / POLITICO — Heartland Institute opens European branch](https://www.eenews.net/articles/heartland-institute-opens-european-branch/)

*Compiled via Aunoo news-intelligence. This SITREP summarises one think-tank assessment as reported by France24, corroborated where noted against primary documentation, and should be verified against the full IRIS report and primary incident reporting before use in decision-making. Attribution in influence operations is probabilistic; confidence levels are stated throughout.*
